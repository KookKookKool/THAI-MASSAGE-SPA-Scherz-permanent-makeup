...
(function setupHeroPlaylist(){
  ...
  // Optimized: Use only 1 video (smallest file: 3.8MB) to minimize data transfer
  const videoSrc = '/vdo/Hero/854399-hd_1280_720_24fps.mp4';
  
  el.src = videoSrc;
  el.loop = true; // Loop the single video
